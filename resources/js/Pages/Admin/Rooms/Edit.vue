<script setup>
    ...
    const form = useForm({
        _method: 'patch',
        numero: props.room.numero,
        tipo: props.room.tipo,
        detalles: props.room.detalles,
        vista: null,
        precio: props.room.precio,
        precio_huesped: props.room.precio_huesped,
        precio_noche_extra: props.room.precio_noche_extra,
    });
...
<template>
    <Head title="Actualizar Habitación" />
    <AppLayout>
        <Forms>
            <h3 class="text-center text-xl mb-2">Acualizar habitación N°{{ room.numero }}</h3>
