<script setup>
    ...
    const form = useForm({
        ...
        para_habitacion: props.service.para_habitacion=== 1 ? true : false,
        detalles: props.service.detalles,
...
<template>
    <Head title="Actualizar Servicio" />
    <AppLayout>
        <Forms>
            <h3 class="text-center text-xl mb-2">Acualizar servicio {{ service.nombre }}</h3>
