    ...
    <AuthenticationCard extended>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-end mt-4">
                <Link :href="route('login')" class="underline text-sm text-rojo-dark hover:text-rojo rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rojo-dark">
                    ¿Ya estás registrado?
                </Link>
